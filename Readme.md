...
Essas instruções irão auxiliar a obtenção de uma cópia do projeto em sua máquina local para desenvolvimento e testes.
...
Aqui são listadas as tecnologias utilizadas no projeto
